...
--
-- Host: 127.0.0.1
-- Tempo de geração: 29-Set-2020 às 22:10
...
INSERT INTO `usuarios` (`id`, `texto`, `fecha`, `numero`) VALUES
(1, 'leomessi', '2020-09-08', 1),
(2, 'neymarjr', '2020-09-09', 2),
(3, 'kunaguero', '2020-09-10', 3),
(4, 'luisitosuarez', '2020-09-11', 4),
(5, 'pepguardiola', '2020-09-12', 5);
